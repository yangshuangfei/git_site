<template>
  ...
  <header id="header">
    <section class="container">
      <h1 id="logo">
        <a href="#" title="史迪仔">
          <img src="~/assets/img/史迪仔.png" width="100%" alt="史迪仔" />
        </a>
      </h1>
      <div class="h-r-nsl">
        <ul class="nav">
          ...
          <li v-if="userInfo.id !== ''" id="is-login-two" class="h - r - user">
            <a href="/ucenter" title>
              <img
                ...
                alt
              />
              <span :id="userInfo.id" class="vam disIb">
...
export default {
  ...
  mounted() {
    ...
    if (token) {
      //将jwt写入cookie
      cookie.set("stitch_jwt_token", token, { domain: "localhost" });
