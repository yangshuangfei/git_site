  ...
  <div id="aCoursesList" class="bg-fa of">
    ...
    <section class="container">
      ...
      <section class="path-wrap txtOf hLh30">
        ...
        <a
          :href="
            '/course?subjectParentId=' +
            course.subjectLevelOneId +
            '&subjectId=' +
            course.subjectLevelTwoId
          "
          class="c-333 fsize14"
          >{{ course.subjectLevelTwo }}</a
        >
      </section>
      <!-- /课程所属分类 结束 -->
                        ...
                        <ul>
                          ...
                          >
                            ...
                            <ol class="lh-menu-ol" style="display: block">
                              <li
                                v-for="classHour in chapter.children"
                                :key="classHour.id"
                              ...
                              >
                                <a
                                  ...
                                  target="_blank"
                                  :href="'/player/' + classHour.videoSourceId"
                                  :title="classHour.title"
                                >
                                  <span
                                    v-if="course.price !== 0 && classHour.free"
                                    class="fr"
                                  >
                                ...
                                <a v-else :title="classHour.title">
                                  <span v-if="classHour.free" class="fr">
                                    <i class="free-icon vam mr10">免费试听</i>
                                  </span>
                                  <em class="lh-menu-i-2 icon16 mr5">&nbsp;</em
                                  >{{ classHour.title }}
...
export default {
  ...
  created() {
    const token = cookie.get("stitch_jwt_token");
    if (token) {
  ...
  methods: {
    ...
    collect(courseId) {
      collectApi.collect(courseId).then((response) => {
        this.isCollect = true;
